...
namespace OpenBve
{
	static partial class Bve5ScenarioParser
	{
		...
		private class Background
		{
			...
			internal readonly BackgroundManager.BackgroundHandle Handle;
		...
		private class SignalData
		{
			...
			internal ObjectManager.StaticObject[] BaseObjects;
			internal ObjectManager.StaticObject[] GlowObjects;
		}
